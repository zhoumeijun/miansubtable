...
//应用编码
export const APPCODE = '91H10101';

//单据类型
export const BILL_TYPE_CODE = 'NCMJ';
 ...
 */
export const LIST = {
        page_title: '91H10101-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '91H10101_LIST',                     //页面编码
...
//请求基础路径
export const base_path = '/nccloud/development/testtable/';

//url
export const REQUEST_URL = {
        save: `/nccloud/development/testtable/savemainEntity.do`,                       //保存
        delete: `/nccloud/development/testtable/deletemainEntity.do`,                        //删除
        queryCard: `/nccloud/development/testtable/querycardmainEntity.do`,                      //卡片查询
        queryList: `/nccloud/development/testtable/querypagemainEntity.do`,              //列表查询
        queryListByPks: `/nccloud/development/testtable/querypagebypkmainEntity.do`,     //列表分页查询
        commit: `/nccloud/development/testtable/commitmainEntity.do`,                   //提交
        unCommit: `/nccloud/development/testtable/uncommitmainEntity.do`,               //收回
...
export const FIELD = {
        org: 'pk_org',                                                   //组织
        //orgV: 'pk_org_v',                                              //组织多版本
        approvestatus: 'approvestatus', //billStatus: 'billstatus',                             //单据状态字段（用以按钮控制）
        ts: 'ts'                                                                 //时间戳
};

//主属性字段名
export const PRIMARY_KEY = {
        head_id: 'pk_m',           //表头主键字段名
        body_id: 'pk_sub',           //表体主键字段名
